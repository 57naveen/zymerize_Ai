...
const PriceCard = ({name,price,description,items,id,paymentLink}:PriceType) =>{
  return(
    <div className='relative w-full max-w-lg hover:scale-105 hover:transition-all duration-300'>
      ...
      <div className='space-y-2.5 leading-relaxed text-base flex-1'>
        {items.map((item,idx)=>(
          <li key={idx} className='flex items-center gap-2' > <CheckIcon size={18}/> <span>{item}</span> </li>
        ))}
      </div>
  ...
  return (
    <div>
      ...
      <div className='py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12'>
        ...
        <div className='relative flex justify-center flex-col lg:flex-row items-center lg:items-stretch gap-0'>
            {plans.map((plan)=>(
