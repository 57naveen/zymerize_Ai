      ...
      <div className="flex flex-col items-center justify-center space-y-4 text-center">
        <div className='space-y-2'>
          ...
          <p className='mx-auto max-w-2xl text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400'>
            Transform lengthy documents into clear, actionable insights with <br />
        ...
        <div>
          <Button variant={'link'} size="lg"  className='w-full min-[400px]:w-auto 
                   bg-linear-to-r from-slate-900 to-rose-500
                  hover:from-rose-500 hover:to-slate-900 hover:no-underline
                  font-bold shadow-lg transition-all duration-300 text-white '>
